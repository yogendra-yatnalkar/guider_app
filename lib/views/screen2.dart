        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            bottom: new TabBar(
              isScrollable: true,
              tabs: <Widget>[
                new Tab(text: 'Places', icon:Icon(FontAwesomeIcons.locationArrow)),
                new Tab(text: 'Parks', icon:Icon(FontAwesomeIcons.tree)),
                new Tab(text: 'Food', icon: Icon(FontAwesomeIcons.utensils)),
                new Tab(text: 'Lodging', icon: Icon(FontAwesomeIcons.hotel)),
              ],
            ),
          ),
          body: new Container(
